...
//
//
var counties = ["Allegany", "Anne Arundel", "Baltimore", "Baltimore City", "Calvert", "Caroline", "Carroll", "Cecil", "Charles", "Dorchester", "Frederick", "Garrett", "Harford", "Howard", "Kent", "Montgomery", "Prince George's", "Queen Anne's", "St. Mary's", "Somerset", "Talbot", "Washington", "Wicomico", "Worcester"];
module.exports = {
  props: ["values"],
  data: function data() {
    return {
  ...
  return _c("form", { staticClass: "mmp-calculator__form" }, [
    _c("div", { staticClass: "mmp-calculator__form-group" }, [
      _c("label", { staticClass: "mmp-calculator__form-label" }, [
        _c("span", [_vm._v("Total Household Income")]),
        _vm._v(" "),
        _c("div", { staticClass: "input-wrap -bordered" }, [
          _c("span", { staticClass: "input-context" }, [_vm._v("$")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.values.householdIncome,
                expression: "values.householdIncome"
              }
            ],
            ...
            on: {
              ...
              input: function($event) {
                ...
                _vm.$set(_vm.values, "householdIncome", $event.target.value)
              }
            }
          })
        ])
        ...
        _c("div", { staticClass: "input-wrap -radios -fit" }, [
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.values.householdSize,
                  expression: "values.householdSize"
                }
              ],
              attrs: { type: "radio", name: "householdSize", value: "1" },
              domProps: { checked: _vm._q(_vm.values.householdSize, "1") },
              on: {
                change: function($event) {
                  return _vm.$set(_vm.values, "householdSize", "1")
                }
              }
            }),
            _c("span", [_vm._v("1")])
          ...
          _c("label", [
            _c("input", {
              ...
              attrs: { type: "radio", name: "householdSize", value: "2" },
              domProps: { checked: _vm._q(_vm.values.householdSize, "2") },
              on: {
                change: function($event) {
                  return _vm.$set(_vm.values, "householdSize", "2")
                }
              }
            }),
            _c("span", [_vm._v("2")])
          ...
          _c("label", [
            _c("input", {
              ...
              attrs: { type: "radio", name: "householdSize", value: "3+" },
              domProps: { checked: _vm._q(_vm.values.householdSize, "3+") },
              on: {
                change: function($event) {
                  return _vm.$set(_vm.values, "householdSize", "3+")
                }
              }
            }),
            _c("span", [_vm._v("3+")])
    ...
    _c("div", { staticClass: "mmp-calculator__form-group" }, [
      _c("label", { staticClass: "mmp-calculator__form-label" }, [
        _c("span", [_vm._v("Location of purchase property")]),
        _vm._v(" "),
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.values.targeted,
                  expression: "values.targeted"
                }
              ],
              attrs: { type: "radio", name: "targeted", value: "1" },
              domProps: { checked: _vm._q(_vm.values.targeted, "1") },
              on: {
                change: function($event) {
                  return _vm.$set(_vm.values, "targeted", "1")
                }
              }
            }),
            _c("span", [_vm._v("Targeted")])
          ]),
          _vm._v(" "),
          _c("label", [
            _c("input", {
              ...
              attrs: { type: "radio", name: "targeted", value: "0" },
              domProps: { checked: _vm._q(_vm.values.targeted, "0") },
              on: {
                change: function($event) {
                  return _vm.$set(_vm.values, "targeted", "0")
                }
              }
            }),
            _c("span", [_vm._v("Non-Targeted")])
          ])
        ])
      ])
    ]),
    ...
    _c("div", { staticClass: "mmp-calculator__form-group" }, [
      _c("div", { staticClass: "mmp-calculator__form-label" }, [
        _c("span", [_vm._v("Are you a first-time homebuyer?")]),
        _vm._v(" "),
        _c("div", { staticClass: "input-wrap -radios -fit" }, [
          _c("label", [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.values.isFirstTimeBuyer,
        ...
        _c("div", { staticClass: "input-wrap -radios -fit" }, [
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.values.isPrimaryResidence,
                  expression: "values.isPrimaryResidence"
                }
              ],
              attrs: { type: "radio", name: "isPrimaryResidence", value: "0" },
              domProps: { checked: _vm._q(_vm.values.isPrimaryResidence, "0") },
              on: {
                change: function($event) {
                  return _vm.$set(_vm.values, "isPrimaryResidence", "0")
                }
              }
            }),
            _c("span", [_vm._v("No")])
          ...
          _c("label", [
            _c("input", {
              ...
              attrs: { type: "radio", name: "isPrimaryResidence", value: "1" },
              domProps: { checked: _vm._q(_vm.values.isPrimaryResidence, "1") },
              on: {
                change: function($event) {
                  return _vm.$set(_vm.values, "isPrimaryResidence", "1")
                }
              }
            }),
            _c("span", [_vm._v("Yes")])
...
module.exports = {
  props: ['values', 'googleSheetId', 'googleApiKey', 'products'],
  data: function data() {
    return {};
  },
  computed: {
    ...
    monthlyPayment: function monthlyPayment() {
      ...
      var income = num(this.values.householdIncome);
      var monthlyIncome = income / 12; // the recommended amount

      var payment = monthlyIncome * 0.28;
      return round(payment, 2);
    }
  },
  methods: {
    getLoanAmount: function getLoanAmount(interestRate) {
...
/*#__PURE__*/
function () {
  function HouseholdLimit(values) {
    _classCallCheck(this, HouseholdLimit);

    this.values = values;
  }

  _createClass(HouseholdLimit, [{
    key: "getIncomeLimit",
    value: function getIncomeLimit(targeted) {
      return targeted ? this.values.incomeTargeted : this.values.incomeNonTargeted || this.values.incomeTargeted;
    }
  }, {
    key: "getAcquisition",
    value: function getAcquisition(targeted) {
      console.log(targeted);
      return targeted ? this.values.acquisitionTargeted : this.values.acquisitionNonTargeted || this.values.acquisitionTargeted;
    }
  }, {
    key: "getMaxMortgageAmount",
    value: function getMaxMortgageAmount() {
...
/*#__PURE__*/
function () {
  function CountyLimit(county) {
    _classCallCheck(this, CountyLimit);

    this.county = county;
    this.households = {};
  }

  _createClass(CountyLimit, [{
    key: "getHousehold",
    value: function getHousehold(n) {
      if (n === '3+') {
    ...
    key: "addHousehold",
    value: function addHousehold(household, values) {
      var householdLimit = new HouseholdLimit(values);
...
var _Results = _interopRequireDefault(require("./Results.vue"));

var _Product = _interopRequireDefault(require("../models/Product"));

var _CountyLimit = _interopRequireDefault(require("../models/CountyLimit"));
...
module.exports = {
  components: {
    CalculatorForm: _CalculatorForm.default,
    Results: _Results.default
  },
  props: ["googleApiKey", "googleSheetId"],
  data: function data() {
    return {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "mmp-calculator" }, [
        ...
        [
          _c("results", {
            ...
            attrs: {
              ...
              values: _vm.values,
              googleApiKey: _vm.googleApiKey,
              googleSheetId: _vm.googleSheetId
            }
          })
        ],
        1
...
function init() {
  var nodes = document.querySelectorAll('[data-component="mmp-mortgage-calculator"]');
  nodes.forEach(function (node) {
    if (node.calculator) {
      return;
    } else {
      window.calculator = new _vue.default({
        el: node,
        render: function render(h) {
